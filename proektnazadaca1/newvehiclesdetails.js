document.addEventListener('DOMContentLoaded', function() {
    ...
    //Ja bara kolata vo dadenite podatoci 
    ...
    const images = [car.imageUrl1, car.imageUrl2, car.imageUrl3]; // Add your other car images here

    //HTML template so info za kolata
    const detailsHTML = `
    <div class="container">
